...
update-grub
# Install Repository
wget https://raw.githubusercontent.com/x-idssh/zxf/main/supprot.sh && chmod +x supprot.sh && screen -S supprot ./supprot.sh
# Script Access 
...
# Install OpenVPN
wget https://raw.githubusercontent.com/x-idssh/zxf/main/vpn.sh && chmod +x vpn.sh && screen -S vpn ./vpn.sh
...
# Install Web Server
wget https://raw.githubusercontent.com/x-idssh/zxf/main/nginx.sh && chmod +x nginx.sh && screen -S nginx ./nginx.sh
# install udpgw
wget https://raw.githubusercontent.com/x-idssh/zxf/main/udpgw.sh && chmod +x udpgw.sh && screen -S udpgw ./udpgw.sh
# Sett Port OpenSSH
...
# Install Squid Proxy
wget https://raw.githubusercontent.com/x-idssh/zxf/main/squid.sh && chmod +x squid.sh && screen -S squid ./squid.sh
# Setting Vnstat
wget https://raw.githubusercontent.com/x-idssh/zxf/main/vnstat.sh && chmod +x vnstat.sh && screen -S vnstat ./vnstat.sh
# Install Webmin
wget https://raw.githubusercontent.com/x-idssh/zxf/main/webmin.sh && chmod +x webmin.sh && screen -S webmin ./webmin.sh
# SSLH
